...
//        let sprite = SKSpriteNode(imageNamed: component1.componentType.spriteName)
//        sprite.position = pointForColumn(component1.column, row: component1.row)
//        componentsLayer.addChild(sprite)
//        othercomponent.sprite = sprite
//        
        
        
        let componentType = ComponentType.Enzyme
        let component3 = Component(column: component1.column, row: component1.row, componentType: componentType)
...
//        sprite.alpha = 0
//        sprite.runAction(SKAction.sequence([SKAction.waitForDuration(3), SKAction.group([SKAction.fadeInWithDuration(0.25), moveAction1])]))
//        
        
        if let sprite = component3.sprite {
            if sprite.actionForKey("removing") == nil {
                let scaleAction = SKAction.scaleTo(0.1, duration: 0.3)
                scaleAction.timingMode = .EaseOut
                sprite.runAction(SKAction.sequence([SKAction.waitForDuration(3), scaleAction, SKAction.removeFromParent()]),
    ...
    func components(component1: Component, component2: Component, componentType: ComponentType, newcomponentType: ComponentType) {
        ...
        moveAction1.timingMode = .EaseOut
        sprite1.alpha = 0
        sprite1.runAction(SKAction.sequence([SKAction.waitForDuration(9), SKAction.group([SKAction.fadeInWithDuration(0.25), moveAction1])]))
        ...
        moveAction2.timingMode = .EaseOut
        sprite2.alpha = 0
        sprite2.runAction(SKAction.sequence([SKAction.waitForDuration(9), SKAction.group([SKAction.fadeInWithDuration(0.25), moveAction2])]))
    ...
    func  combinedpiece(component1: Component, component2: Component, newcomponentType: ComponentType) {
        ...
        moveAction.timingMode = .EaseOut
        sprite.alpha = 0
        sprite.runAction(SKAction.sequence([SKAction.waitForDuration(6), SKAction.fadeInWithDuration(time), moveAction]))
        
        let scaleAction = SKAction.scaleTo(0.1, duration: 0.3)
        //sprite.runAction(SKAction.sequence([SKAction.waitForDuration(delay, withRange: 5), scaleAction, SKAction.removeFromParent()]),
            sprite.runAction(SKAction.sequence([SKAction.waitForDuration(8), scaleAction, SKAction.removeFromParent()]),
